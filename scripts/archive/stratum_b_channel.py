...
Usage:
    python scripts/archive/stratum_b_channel.py --pairs
    python scripts/archive/stratum_b_channel.py --trace finqa_dev_447
    python scripts/archive/stratum_b_channel.py --survival 300
"""
