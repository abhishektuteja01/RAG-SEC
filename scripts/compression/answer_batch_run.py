...
Usage:
    python scripts/compression/answer_batch_run.py --dry-run          # plan + JSONL, no spend
    python scripts/compression/answer_batch_run.py --limit 5          # 10 requests, ~$0.04
    python scripts/compression/answer_batch_run.py                    # full payload
"""
